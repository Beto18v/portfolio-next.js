    ...
    skillGroups: [
      {
        ...
        skills: [
          ...
          "LangGraph",
          "RAG",
          "Multi-Provider LLMs (AWS Bedrock, OpenAI, Gemini, Groq, Ollama)",
          "Vector Databases (Qdrant / FAISS / pgvector)",
          "Embedding Models (Cohere, OpenAI, HuggingFace)",
          "Function Calling",
          "Structured Outputs (Pydantic/Instructor)",
          "Prompt Engineering",
          "Guardrails (Prompt Injection Defense, Rate Limiting)",
        ],
      },
      {
        title: "LLMOps",
